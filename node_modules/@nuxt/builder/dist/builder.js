/*!
 * @nuxt/builder v2.5.1 (c) 2016-2019
...
class Builder {
  ...
  async compileTemplates(templateContext) {
    ...
    await Promise.all(
      templateFiles.map(async ({ src, dst, options, custom }) => {
        ...
        const _path = utils.r(this.options.buildDir, dst);
  ...
  watchClient() {
    ...
    let patterns = [
      ...
      utils.r(src, this.options.dir.store),
  ...
  watchRestart() {
    const nuxtRestartWatch = [
      // Server middleware
      ...this.options.serverMiddleware.filter(utils.isString),
      // Custom watchers
      ...this.options.watch
