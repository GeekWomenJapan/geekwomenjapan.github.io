...
function hotLoader(content, context) {
  ...
  const result = `${content}
    if(module.hot) {
      // ${Date.now()}
      var cssReload = require(${_loaderUtils2.default.stringifyRequest(context.context, _path2.default.join(__dirname, 'hmr/hotModuleReplacement.js'))})(module.id, ${JSON.stringify(context.query)});
...
function pitch(request) {
  ...
  childCompiler.runAsChild((err, entries, compilation) => {
    ...
    resultSource += query.hot ? hotLoader(result, { context: this.context, query, locals }) : result;
